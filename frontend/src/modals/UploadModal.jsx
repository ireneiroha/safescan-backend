...
export default function UploadModal({ onClose, onFileSelected }) {
    ...
    const handleDone = () => {
        if (uploadFile && progress === 100) onFileSelected(uploadFile)
    }
        ...
        <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center bg-black/60 backdrop-blur-sm px-4 pb-4 md:pb-0">
            <div className="bg-white rounded-3xl p-6 w-full max-w-sm shadow-2xl">
                ...
                >
                    ...
                    <p className="text-sm text-text-secondary text-center">Drag and drop or <span className="text-primary font-semibold">browse</span> your files</p>
                    ...
                    <div className="flex items-center gap-3 mb-5">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="flex justify-between mt-0.5">
                                <p className="text-xs text-text-secondary">{(uploadFile.size / (1024 * 1024) * progress / 100).toFixed(1)} MB of {(uploadFile.size / (1024 * 1024)).toFixed(1)} MB</p>
                ...
                <div className="flex flex-col gap-2.5">
                    <button type="button" onClick={handleDone} disabled={!uploadFile || uploading}
